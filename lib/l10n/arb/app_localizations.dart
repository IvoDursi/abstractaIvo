...
abstract class AppLocalizations {
  ...
  /// No description provided for @assignationRequired.
  ///
  /// In en, this message translates to:
  /// **'Assignation required'**
  String get assignationRequired;
  ...
  /// No description provided for @deleteTaskDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @iaMode.
  ///
  /// In en, this message translates to:
  /// **'IA Mode'**
  String get iaMode;

  /// No description provided for @iaInstructions.
  ///
  /// In en, this message translates to:
  /// **'Instruction for AI'**
  String get iaInstructions;

  /// No description provided for @iaInstructionsHint.
  ///
  /// In en, this message translates to:
  /// **'Describe what task you need to create...'**
  String get iaInstructionsHint;
